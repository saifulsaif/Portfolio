	...
	<div class="container">
		<div class="top">
			<h1 id="title" class="hidden"><span id="logo">WELCOME <span></span></span></h1>
              ...
              <form action="<?php echo base_url(); ?>admin_login/change_password" method="post" class="niceform">
                          <h4 style="color:red;">
          <?php 
      ...
      <h4 style="color:green;">
		...
		<div class="login-box animated fadeInUp">
			...
			<br/>
			<input type="password" name="old_admin_password" id="password">
                        <br/>
                        <label for="password"> New Password</label>
			<br/>
			<input type="password" name="new_admin_password" id="password">
			<br/>
